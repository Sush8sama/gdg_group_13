...
response = rag.retrieval_query(
    ...
    text="Wat doe ik als ik mijn bankkaart kwijt ben?",
...
rag_model = GenerativeModel(model_name="gemini-2.5-flash", tools=[rag_retrieval_tool])

# Generate response
print("\n3. Generating response with RAG...")
response = rag_model.generate_content("can i open a new account?")
print("\nGenerated response:")
print(response.text)
